...
$serverAddress = gethostbyaddr($_SERVER['SERVER_ADDR']);
$serverAddress = $serverAddress[0].substr(array_shift(explode('.',$serverAddress)),-4,4);
?>
...
<div class="sfTContainer">
  ...
  <div class="sfTMessageContainer sfTAlert">
    ...
    <div class="sfTMessageWrap">
      ...
      <h5 title="<?php echo $_SERVER['SERVER_NAME'] ; ?>">The server returned a "500 Internal Server Error".</h5>
    </div>
  </div>
  ...
  <dl class="sfTMessageInfo">
    ...
    Sorry for any inconvenience caused by <?php echo $serverAddress ?>.</dd>
    <dt>What's next</dt>
    <dd>
