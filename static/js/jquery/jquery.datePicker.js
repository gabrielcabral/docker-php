        ...
        datePicker : function(s)
        {
            ...
            return this.each(
                function()
                {
                    ...
                    if(isDisabled){
                        defaultStatusClass = ' dp-disabled';
                    }else{
                        defaultStatusClass = '';
                    }
                    ...
                    if (!alreadyExists && s.createButton) {
                        // create it!
                        controller.button = $('<a href="#" class="dp-choose-date'+defaultStatusClass+'" title="' + $.dpText.TEXT_CHOOSE_DATE + '">' + $.dpText.TEXT_CHOOSE_DATE + '</a>')
                        .bind(
                            'click',
                            function()
                            {
                    ...
                    if (!alreadyExists && $this.is(':text')) {
                        ...
                        .bind(
                            ...
                            if(this.value != ''){
                                if(Helper.Date.validate(this.value)){
                                    dateInputed = Date.fromString(this.value);
                                    if(dateInputed.getTime() < controller.startDate.getTime() || dateInputed.getTime() > controller.endDate.getTime()){
                                        Dialog.alert('A data deve ser selecionada entre '+controller.startDate.asString()+' &agrave; '+controller.endDate.asString(),'Atenção',function(){
                                            $this.val('');
                                            $this.focus();
                                        });
                                    }                                    
 ...
 **/
    ...
    $.extend(
        DatePicker.prototype,
        {
            ...
            {
                isDisabled = $(this.ele).attr('disabled');
                ...
                $td.bind(
                    ...
                    function()
                    {
                        ...
                        if (!$this.is('.disabled')) {
                            ...
                            if (c.closeOnSelect) {
                                // Focus the next input in the formï¿½
