...
/**
 * Form de Filtro MesoRegiao
 * 
 * @author tiago.ramos
 * @since 03/04/2012
 */
class MesoRegiao_FormFilter extends Fnde_Base_Form {
	/**
	 * Construtor do formulário de pesquisa da tela de Mesorregião.
	 *
	...
	public function __construct( $arDados, $arExtra ) {
		...
		$this->addElements(array($nunoMesoRegiao, $nucoMunicipioIbge, $nunoMunicipio, $nunoUf, $nucoUf,));

		$this->addDisplayGroup(array('NO_MESO_REGIAO', 'CO_MUNICIPIO_IBGE', 'NO_MUNICIPIO', 'NO_UF', 'CO_UF',),
				'dadosmesoregiao', array("legend" => "Filtro MesoRegiao"));
		...
		$btCancelar = $this->createElement('button', 'cancelar',
				array("label" => "Cancelar", "value" => "Cancelar", "class" => "btnCancelar", "title" => "Cancelar",
						'onClick' => "window.location='" . $this->getView()->baseUrl()
								. "/index.php/manutencao/mesoregiao/clear-search/'"));
