 ...
 * @since 28/05/2012
 */
class FinalizarTurma_Form extends Fnde_Form {
	/**
	 * Construtor do formulário da tela de Finalização da Turma.
	 *
	...
	public function __construct( $arDados, $arExtra ) {
		...
		$btConfirmar = $this->createElement('submit', 'confirmar',
				array("label" => "Confirmar", "value" => "Confirmar",
						"mensagem" => "Deseja realmente solicitar autorização da turma?", "class" => "btnConfirmar",
						"title" => "Confirmar"));
