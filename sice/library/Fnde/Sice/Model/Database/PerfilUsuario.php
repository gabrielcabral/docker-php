...
/**
 * Classe de Modelo do tipo Database: Fnde_Sice_Model_PerfilUsuario
 * @uses Fnde_Model_Database_Abstract
 * @version $Id$
 */
abstract class Fnde_Sice_Model_Database_PerfilUsuario extends Fnde_Model_Database_Abstract
{
    protected $_schema   = 'SICE_FNDE';
    protected $_name     = 'H_PERFIL_USUARIO';
    protected $_sequence = 'SICE_FNDE.HPUS_NU_SEQ_HIST_PERFIL_SQ';
    ...
    protected $_metadata = array(
        'NU_SEQ_HIST_PERFIL' => array(
            'SCHEMA_NAME' => 'SICE_FNDE',
            'TABLE_NAME' => 'H_PERFIL_USUARIO',
            'COLUMN_NAME' => 'NU_SEQ_HIST_PERFIL',
            'COLUMN_POSITION' => '1',
            'DATA_TYPE' => 'NUMBER',
            'DEFAULT' => null,
            'NULLABLE' => false,
